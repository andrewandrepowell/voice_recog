...
#set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports {spi_0_ss_io[0]}]

#set_false_path -from [get_clocks clk_out3_block_design_clk_wiz_1_0] -to [get_clocks clk_out1_block_design_clk_wiz_1_0]
#set_false_path -from [get_clocks clk_out3_block_design_clk_wiz_1_0_1] -to [get_clocks clk_out1_block_design_clk_wiz_1_0]
